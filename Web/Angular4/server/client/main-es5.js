...
var ProductDetailComponent = /** @class */ (function () {
    ...
    ProductDetailComponent.prototype.addComment = function () {
        var comment = new _shared_product_service__WEBPACK_IMPORTED_MODULE_1__["Comment"](0, this.product.id, new Date().toLocaleDateString(), 'someone', this.newRating, this.newComment);
        this.comments.unshift(comment); // 向原评论数组添加新的评论元素
        // tslint:disable-next-line:no-shadowed-variable
        var sum = this.comments.reduce(function (sum, comment) { return sum + comment.rating; }, 0); // 从 0 开始，依次加遍comments里的每个元素
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.search = function (params) {
        var url = '/api/products?' + this.encodeParams(params);
...
var WebSocketService = /** @class */ (function () {
    ...
    WebSocketService.prototype.createObservableSocket = function (url, id) {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_0__["Observable"](function (observer) {
            ...
            return function () { return _this.ws.close.bind(_this.ws); };
        }
        // @ts-ignore
        ).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (message) { return JSON.parse(message); }));
    };
